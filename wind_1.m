...
y=Add_Note(t,y,fs,Base_Key-5,1,1,(Off_Set+[0,1])/Rate);
y=Add_Note(t,y,fs,Base_Key+0,1,1,(Off_Set+[1,2])/Rate);
y=Add_Note(t,y,fs,Base_Key-4,1,1,(Off_Set+[2,4])/Rate);
y=Add_Note(t,y,fs,Base_Key-1,1,1,(Off_Set+[3,4])/Rate);
...
y=Add_Note(t,y,fs,Base_Key+4,-1,1,(Off_Set+[1.8,3.9])/Rate);
y=Add_Note(t,y,fs,Base_Key+-4,0,1,(Off_Set+[1.87,3.9])/Rate);
y=Add_Note(t,y,fs,Base_Key+-1,0,1,(Off_Set+[1.93,3.9])/Rate);
y=Add_Note(t,y,fs,Base_Key+4,0,1,(Off_Set+[2,3.9])/Rate);
...
y=Add_Note(t,y,fs,Base_Key+5,1,1,(Off_Set+[2,3])/Rate);
y=Add_Note(t,y,fs,Base_Key+0,0,1,(Off_Set+[3,4])/Rate);
y=Add_Note(t,y,fs,Base_Key+0,0,1,(Off_Set+[2,4])/Rate);
%=========  8  ==========
Off_Set=28;
y=Add_Note(t,y,fs,Base_Key+-5,1,1,(Off_Set+[0,0.9])/Rate);
y=Add_Note(t,y,fs,Base_Key+0,1,1,(Off_Set+[1,1.05])/Rate);
...
%========  Play % Save =============
sound(y/max(y)/2,fs)
audiowrite('wind.wav',y/max(abs(y))*0.9,fs)